...
[FILE "a_nask.nas"]                 ; 源文件名信息
        GLOBAL  _api_putchar, _api_putstr, _api_getkey
		GLOBAL	_api_openwin, _api_putstrwin, _api_boxfilwin, _api_point, _api_refreshwin, _api_line
		GLOBAL	_api_openwin_buf, _api_initmalloc, _api_malloc, _api_free, _api_closewin
